...
const UploadSongForm = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-gray-800 to-gray-900">
      <form onSubmit={handleUpload} className="w-full max-w-md bg-gray-900 m-8 rounded-xl shadow-lg p-8">
        ...
        />
        {audioFile && <p className="text-sm text-gray-400 mb-2">Selected: {audioFile.name}</p>}
